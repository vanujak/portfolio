    ...
    const fetchLastCommit = async () => {
      try {
        const response = await fetch(
          "https://api.github.com/repos/vanujak/portfolio/commits",
          {
            headers: {
        ...
        if (response.ok) {
          ...
          if (commits && commits.length > 0) {
            ...
            const formattedDate = new Date(commitDate).toLocaleDateString(
              "en-US",
              {
                month: "long",
                day: "numeric",
            ...
            <div className="flex-grow overflow-y-auto space-y-4 pr-1 text-sm text-zinc-650 dark:text-zinc-400 leading-relaxed custom-scrollbar select-text">
              {activeModal === "privacy" ? (
                <>
                  ...
                  <p>
                    This portfolio website is a static showcase constructed
                    using Next.js, styled with Tailwind CSS, and hosted via
                    GitHub Pages. I am committed to protecting your online
                    privacy.
                  </p>
                  ...
                  <p>
                    This website does not collect, record, track, store, or
                    share any personal identifying information or data of its
                    visitors. There are no cookies, marketing tags, or tracking
                    pixels loaded.
                  </p>
                  ...
                  <p>
                    This site communicates client-side with public APIs
                    (specifically GitHub and LeetCode) to retrieve coding and
                    contribution statistics. These requests are anonymous and do
                    not transmit or save personal details.
                  </p>
                  ...
                  <p>
                    I provide outbound links to third-party services (such as
                    GitHub, LinkedIn, and Telegram). Please note that once you
                    leave this site, you are bound by the privacy policies and
                    statements of those respective platforms.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p>
                    By accessing and exploring this portfolio, you agree to
                  ...
                  <p>
                    The codebase for this portfolio is open-source under the MIT
                    License. You are permitted to reference the code, clone the
                    repository, or use sections of the layout for building your
                  ...
                  <p>
                    All technical skills, academic details, projects, and
                    certifications shown on this site represent my authentic
                    professional accomplishments, projects, and coursework
                    history.
                  </p>
                  ...
                  <p>
                    This website is provided for informational and showcase
                    purposes on an "as-is" basis, without any warranties or
                    guarantees of uptime or software consistency.
                  </p>
                </>
              )}
            </div>
